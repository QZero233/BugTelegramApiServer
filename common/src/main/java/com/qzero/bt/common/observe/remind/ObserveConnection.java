...
public class ObserveConnection extends Thread {
    ...
    private ObserveConnectionManager.ClientDisconnectedCallback callback;

    private ServerSocket serverSocket;
    private Socket socket;

    public ObserveConnection(String userName, ObserveConnectionManager.ClientDisconnectedCallback callback) {
